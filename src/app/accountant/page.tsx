    ...
    <div className="max-w-6xl mx-auto space-y-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Manage your work log and accounting modules.</p>
        </div>
        <Link href="/accountant/transactions" className={buttonVariants({ className: "gap-2" })}>
          <FileText className="h-4 w-4" /> Go to Transactions
        </Link>
      </div>
      ...
      <div className="flex flex-col gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-xl">Accounting Quick Actions</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4 flex flex-col md:flex-row gap-3 md:gap-6">
            <Link href="/accountant/transactions/new?type=SALE" className={buttonVariants({ variant: "outline", className: "justify-start h-12 gap-3" })}>
              <IndianRupee className="h-5 w-5 text-green-600" />
              <span className="text-lg">Record Sale</span>
            </Link>
            <Link href="/accountant/transactions/new?type=PURCHASE" className={buttonVariants({ variant: "outline", className: "justify-start h-12 gap-3" })}>
              <FileText className="h-5 w-5 text-blue-600" />
              <span className="text-lg">Record Purchase</span>
            </Link>
            <Link href="/accountant/transactions/new?type=REPAIR" className={buttonVariants({ variant: "outline", className: "justify-start h-12 gap-3" })}>
              <FileText className="h-5 w-5 text-orange-600" />
              <span className="text-lg">Record Repair</span>
            </Link>
            <Link href="/accountant/transactions/new?type=REPLACEMENT" className={buttonVariants({ variant: "outline", className: "justify-start h-12 gap-3" })}>
              <FileText className="h-5 w-5 text-purple-600" />
              <span className="text-lg">Record Replacement</span>
            </Link>
          </CardContent>
        </Card>
